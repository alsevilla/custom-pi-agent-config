...
<required_reading>
@$HOME/.pi/agent/gsd-core/references/user-story-template.md
@$HOME/.pi/agent/gsd-core/references/spidr-splitting.md
@$HOME/.pi/agent/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@$HOME/.pi/agent/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@$HOME/.pi/agent/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@$HOME/.pi/agent/gsd-core/references/spidr-splitting.md`. Briefly:
