...
<template>
@$HOME/.pi/agent/gsd-core/templates/UAT.md
</template>
...
Read and follow `$HOME/.pi/agent/gsd-core/workflows/transition.md`.
...
- Follow @$HOME/.pi/agent/gsd-core/workflows/diagnose-issues.md
