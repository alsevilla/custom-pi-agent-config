...
<required_reading>
@$HOME/.pi/agent/gsd-core/references/ai-frameworks.md
@$HOME/.pi/agent/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read $HOME/.pi/agent/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "$HOME/.pi/agent/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read $HOME/.pi/agent/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read $HOME/.pi/agent/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read $HOME/.pi/agent/agents/gsd-eval-planner.md for instructions.
