...
Key references:
- @$HOME/.pi/agent/gsd-core/references/ui-brand.md (display patterns)
- @$HOME/.pi/agent/agents/gsd-user-profiler.md (profiler agent definition)
- @$HOME/.pi/agent/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="$HOME/.pi/agent/gsd-core/USER-PROFILE.md"
...
```bash
cp "$HOME/.pi/agent/gsd-core/USER-PROFILE.md" "$HOME/.pi/agent/USER-PROFILE.backup.md"
```
...
✓ Stores profile at $HOME/.pi/agent/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `$HOME/.pi/agent/gsd-core/references/user-profiling.md`
...
Reference: @$HOME/.pi/agent/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to $HOME/.pi/agent/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to $HOME/.pi/agent/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at $HOME/.pi/agent/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at $HOME/.pi/agent/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to $HOME/.pi/agent/CLAUDE.md"
...
```bash
BACKUP_PATH="$HOME/.pi/agent/USER-PROFILE.backup.md"
```
...
Your profile:    $HOME/.pi/agent/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   $HOME/.pi/agent/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.pi/CLAUDE.md>
  ✓ Global CLAUDE.md        $HOME/.pi/agent/CLAUDE.md
```
