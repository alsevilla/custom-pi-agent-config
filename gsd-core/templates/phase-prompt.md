...
<!-- For checkpoint task examples and patterns, see @$HOME/.pi/agent/gsd-core/references/checkpoints.md -->
...
See `$HOME/.pi/agent/gsd-core/references/tdd.md` for TDD plan structure.
...
See `$HOME/.pi/agent/gsd-core/templates/user-setup.md` for full schema and examples
