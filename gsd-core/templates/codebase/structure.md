...
- Usage: Reference from command with `@$HOME/.pi/agent/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to $HOME/.pi/agent/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to $HOME/.pi/agent/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
