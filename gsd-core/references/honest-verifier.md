...
`@$HOME/.pi/agent/gsd-core/references/edge-probe.md` (which *classifies* non-inferable checks) and
`@$HOME/.pi/agent/gsd-core/references/prohibition-probe.md` (whose judgment-tier disposition this mirrors).
